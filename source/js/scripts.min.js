...
video1.addEventListener('click', togglePlay, {passive: true});
video1.addEventListener('timeupdate', handleProgress, {passive: true});
let mousedown = !1;
progress1.addEventListener('click', scrub, {passive: true});
